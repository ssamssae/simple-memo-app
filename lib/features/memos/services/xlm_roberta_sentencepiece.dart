...
abstract interface class MiniLmTokenizer {
  XlmRobertaEncoding encode(String text);
}

class XlmRobertaSentencePiece implements MiniLmTokenizer {
  ...
  // Pinned MiniLM uses XLM-R's nmt_nfkc charsmap. Per-scalar NFKC matches
  // SentencePiece without composing decomposed Hangul jamo.
