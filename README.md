...
- 메모 공유 — 편집 화면 AppBar 의 공유 버튼으로 시스템 share sheet 호출 (사진이 있으면 파일도 함께 동봉)
- 메모에 사진 첨부 — 사진첩·카메라·클립보드 붙여넣기, 메모당 최대 10장, 긴 변 1600px JPEG 로 축소해 기기 안에만 저장 (백업 미포함), 편집 화면 본문 아래 썸네일 줄 + 전체화면 뷰어(핀치 확대), 목록·검색·휴지통 행 썸네일
